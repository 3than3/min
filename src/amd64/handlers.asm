...
%macro handler_with_error_code 1
	; Interrupt frame already on the stack
	push %1
	push rax
 	push rbx
...
align_check_handler:
	handler_with_error_code 17

global machine_check_handler
machine_check_handler:
	handler_with_error_code 18
